...
export default function IngredientBenefit() {
  ...
  const handleNext = () => {
    navigate('/ingredients/properties');
  };
...
{/* Form */}
    ...
    className=" bg-white p-4 rounded shadow " 
      ...
      autoComplete="off"
    >
         <h6 className="m-0">Why To Use ?</h6>
          ...
          <div className='d-flex align-items-center gap-1'>
            <TextField className=' w-100' size="small" label="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been." id="field2" />
            <i class="fa-solid fa-xmark" style={{ cursor: 'pointer', fontSize: '1.5rem', color: 'grey'}}></i>
          </div>                        
          

    <h6 className="mt-0">Prakriti Impact</h6>
      <div>
        <TextField
          size="small"
